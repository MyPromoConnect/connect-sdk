...
namespace MyPromo\Connect\SDK\Models\Client;
...
class Connector implements Arrayable
{
     ...
     *
     * e.g.
     * \MyPromo\Connect\SDK\Models\Client\ConnectorConfigurationShopify
     * \MyPromo\Connect\SDK\Models\Client\ConnectorConfigurationMagento
     * ...
     */
    ...
    public function toArray(): array
    {
        ...
        if ($this->configuration instanceof \MyPromo\Connect\SDK\Models\Client\ConnectorConfigurationShopify) {
            $clientConnectorArray['configuration'] = $this->configuration->toArray();
        }

        if ($this->configuration instanceof \MyPromo\Connect\SDK\Models\Client\ConnectorConfigurationMagento) {
            $clientConnectorArray['configuration'] = $this->configuration->toArray();
        }
